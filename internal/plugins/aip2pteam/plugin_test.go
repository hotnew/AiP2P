...
import (
	...
	themeaip2p "aip2p/internal/themes/aip2p"
)
...
func TestPluginBuildServesTeamIndex(t *testing.T) {
  ...
  {"agent_id":"agent://pc75/live-alpha","role":"member","status":"active"}
	...
	req := newChineseRequest(http.MethodGet, "/teams", nil)
...
func TestPluginBuildServesTeamArchiveRoutes(t *testing.T) {
	...
	req := newChineseRequest(http.MethodGet, "/archive/team", nil)
	rec := httptest.NewRecorder()
	site.Handler.ServeHTTP(rec, req)
	...
	req = newChineseRequest(http.MethodGet, "/archive/team/archive-project/"+record.ArchiveID, nil)
	rec = httptest.NewRecorder()
	site.Handler.ServeHTTP(rec, req)
...
func TestPluginBuildServesTeamWebhookAndA2APages(t *testing.T) {
  ...
  "endpoint":"https://example.test/a2a"
	...
	webhookReq := newChineseRequest(http.MethodGet, "/teams/product-team/webhooks", nil)
	...
	a2aReq := newChineseRequest(http.MethodGet, "/teams/product-team/a2a", nil)
...
func TestPluginBuildServesTeamSearchPageAndAPI(t *testing.T) {
  ...
  "channels":["main","research"]
	...
	pageReq := newChineseRequest(http.MethodGet, "/teams/search-team/search?q=alpha", nil)
...
func TestPluginBuildServesPlanExchangeRoomPlugin(t *testing.T) {
  ...
  "structured_data":{
	...
	webReq := newChineseRequest(http.MethodGet, "/teams/plan-room-team/r/plan-exchange/?channel_id=main&kind=skill&actor_agent_id=agent://pc75/live-bravo", nil)
  ...
  "actor_agent_id":"agent://pc75/live-bravo"
	...
	webAfterDistillReq := newChineseRequest(http.MethodGet, "/teams/plan-room-team/r/plan-exchange/?channel_id=main&kind=skill&actor_agent_id=agent://pc75/live-bravo", nil)
	...
	webSnippetReq := newChineseRequest(http.MethodGet, "/teams/plan-room-team/r/plan-exchange/?channel_id=main&kind=snippet&actor_agent_id=agent://pc75/live-bravo", nil)
...
func TestPluginBuildServesReviewRoom(t *testing.T) {
  ...
  "structured_data":{
	...
	webReq := newChineseRequest(http.MethodGet, "/teams/review-room-team/r/review-room/?channel_id=main&kind=decision&actor_agent_id=agent://pc75/live-bravo", nil)
	webRec := httptest.NewRecorder()
	site.Handler.ServeHTTP(webRec, webReq)
	if webRec.Code != http.StatusOK {
  ...
  "structured_data":{
	...
	laneReq := newChineseRequest(http.MethodGet, "/teams/review-room-team/r/review-room/?channel_id=main&actor_agent_id=agent://pc75/live-bravo", nil)
  ...
  "status":"doing"
	...
	webAfterDistillReq := newChineseRequest(http.MethodGet, "/teams/review-room-team/r/review-room/?channel_id=main&actor_agent_id=agent://pc75/live-bravo", nil)
	webAfterDistillRec := httptest.NewRecorder()
	site.Handler.ServeHTTP(webAfterDistillRec, webAfterDistillReq)
	if webAfterDistillRec.Code != http.StatusOK {
  ...
  "actor_agent_id":"agent://pc75/live-bravo"
	...
	webAfterBatchReq := newChineseRequest(http.MethodGet, "/teams/review-room-team/r/review-room/?channel_id=main&actor_agent_id=agent://pc75/live-bravo", nil)
  ...
  "structured_data":{
	...
	globalWebReq := newChineseRequest(http.MethodGet, "/teams/review-room-team/r/review-room/?channel_id=main&actor_agent_id=agent://pc75/live-bravo", nil)
...
func TestPluginBuildServesIncidentRoom(t *testing.T) {
  ...
  "actor_agent_id":"agent://pc75/live-bravo"
	...
	webReq := newChineseRequest(http.MethodGet, "/teams/incident-room-team/r/incident-room/?channel_id=main&actor_agent_id=agent://pc75/live-bravo", nil)
	webRec := httptest.NewRecorder()
	site.Handler.ServeHTTP(webRec, webReq)
	if webRec.Code != http.StatusOK {
...
func TestPluginBuildServesHandoffRoom(t *testing.T) {
  ...
  "actor_agent_id":"agent://pc75/live-alpha"
	...
	webReq := newChineseRequest(http.MethodGet, "/teams/handoff-room-team/r/handoff-room/?channel_id=main&actor_agent_id=agent://pc75/live-alpha", nil)
	webRec := httptest.NewRecorder()
	site.Handler.ServeHTTP(webRec, webReq)
	if webRec.Code != http.StatusOK {
...
func TestPluginBuildServesArtifactRoom(t *testing.T) {
  ...
  "actor_agent_id":"agent://pc75/live-alpha"
	...
	webReq := newChineseRequest(http.MethodGet, "/teams/artifact-room-team/r/artifact-room/?channel_id=main&actor_agent_id=agent://pc75/live-alpha", nil)
	webRec := httptest.NewRecorder()
	site.Handler.ServeHTTP(webRec, webReq)
	if webRec.Code != http.StatusOK {
...
func TestPluginBuildServesDecisionRoom(t *testing.T) {
  ...
  "actor_agent_id":"agent://pc75/live-alpha"
	...
	webReq := newChineseRequest(http.MethodGet, "/teams/decision-room-team/r/decision-room/?channel_id=main&actor_agent_id=agent://pc75/live-alpha", nil)
	webRec := httptest.NewRecorder()
	site.Handler.ServeHTTP(webRec, webReq)
	if webRec.Code != http.StatusOK {
...
func TestPluginBuildServesTeamDetailAndAPI(t *testing.T) {
  ...
  "system_note_roles": ["owner"]
	...
	req := newChineseRequest(http.MethodGet, "/teams/project-beta", nil)
	rec := httptest.NewRecorder()
	site.Handler.ServeHTTP(rec, req)
	if rec.Code != http.StatusOK {
		t.Fatalf("status = %d, body = %s", rec.Code, rec.Body.String())
	...
	channelReq := newChineseRequest(http.MethodGet, "/teams/project-beta/channels/research", nil)
	channelRec := httptest.NewRecorder()
	site.Handler.ServeHTTP(channelRec, channelReq)
	if channelRec.Code != http.StatusOK {
	...
	tasksPageReq := newChineseRequest(http.MethodGet, "/teams/project-beta/tasks", nil)
	...
	taskPageReq := newChineseRequest(http.MethodGet, "/teams/project-beta/tasks/team-task-implement-teamtask", nil)
  ...
  "metadata": {"owner":"pm"}
	...
	teamDetailPageReq := newChineseRequest(http.MethodGet, "/teams/project-beta", nil)
	...
	channelThemeReq := newChineseRequest(http.MethodGet, "/teams/project-beta/channels/research", nil)
	...
	channelWorkbenchReq := newChineseRequest(http.MethodGet, "/teams/project-beta/channels/research?view=channel", nil)
	...
	focusThemeReq := newChineseRequest(http.MethodGet, "/teams/project-beta/channels/research", nil)
	...
	boardThemeReq := newChineseRequest(http.MethodGet, "/teams/project-beta/channels/research", nil)
	...
	membersPageReq := newChineseRequest(http.MethodGet, "/teams/project-beta/members", nil)
  ...
  "system_note_roles": ["owner", "maintainer"]
	...
	historyPageReq := newChineseRequest(http.MethodGet, "/teams/project-beta/history", nil)
	...
	filteredHistoryPageReq := newChineseRequest(http.MethodGet, "/teams/project-beta/history?scope=channel", nil)
  ...
  "structured_data": {"task_id":"team-task-implement-teamtask"}
	...
	filteredTasksPageReq := newChineseRequest(http.MethodGet, "/teams/project-beta/tasks?status=doing&label=rollout&channel=research", nil)
  ...
  "labels": ["rollout", "beta", "urgent"]
	...
	taskPageReq = newChineseRequest(http.MethodGet, "/teams/project-beta/tasks/team-task-beta-2", nil)
	taskPageRec = httptest.NewRecorder()
	site.Handler.ServeHTTP(taskPageRec, taskPageReq)
	if taskPageRec.Code != http.StatusOK {
  ...
  "channel_id": "research"
	...
	artifactsPageReq := newChineseRequest(http.MethodGet, "/teams/project-beta/artifacts", nil)
	...
	artifactsFilteredPageReq := newChineseRequest(http.MethodGet, "/teams/project-beta/artifacts?kind=markdown&channel=research", nil)
	...
	artifactPageReq := newChineseRequest(http.MethodGet, "/teams/project-beta/artifacts/artifact-beta-1", nil)
...
func TestPluginBuildHandlesTeamTaskStatusAndArtifactTaskRelation(t *testing.T) {
	...
	taskPageReq := newChineseRequest(http.MethodGet, "/teams/project-task-artifact/tasks/task-artifact-1", nil)
	taskPageRec := httptest.NewRecorder()
	site.Handler.ServeHTTP(taskPageRec, taskPageReq)
	if taskPageRec.Code != http.StatusOK {
		t.Fatalf("task page status = %d, body = %s", taskPageRec.Code, taskPageRec.Body.String())
	...
	tasksPageReq := newChineseRequest(http.MethodGet, "/teams/project-task-artifact/tasks", nil)
	tasksPageRec := httptest.NewRecorder()
	site.Handler.ServeHTTP(tasksPageRec, tasksPageReq)
	if tasksPageRec.Code != http.StatusOK {
		t.Fatalf("tasks page status = %d, body = %s", tasksPageRec.Code, tasksPageRec.Body.String())
	...
	artifactPageReq := newChineseRequest(http.MethodGet, "/teams/project-task-artifact/artifacts/"+url.PathEscape(artifacts[0].ArtifactID), nil)
	artifactPageRec := httptest.NewRecorder()
	site.Handler.ServeHTTP(artifactPageRec, artifactPageReq)
	if artifactPageRec.Code != http.StatusOK {
		t.Fatalf("artifact page status = %d, body = %s", artifactPageRec.Code, artifactPageRec.Body.String())
...
func TestPluginBuildServesAndResolvesTeamSyncConflicts(t *testing.T) {
  ...
  "action":"dismiss"
	...
	detailReq := newChineseRequest(http.MethodGet, "/teams/sync-conflict-team", nil)
	...
	pageReq := newChineseRequest(http.MethodGet, "/teams/sync-conflict-team/history", nil)
	pageRec := httptest.NewRecorder()
	site.Handler.ServeHTTP(pageRec, pageReq)
	if pageRec.Code != http.StatusOK {
...
func TestBuildTeamSyncConflictViewsExplainsSuggestions(t *testing.T) {
	...
	views := buildTeamSyncConflictViews([]coreaip2p.TeamSyncConflictRecord{
		{
...
func TestPluginBuildServesTeamSyncHealthPageAndAPI(t *testing.T) {
  ...
  "owner_agent_id":"agent://pc75/live-alpha"
	...
	pageReq := newChineseRequest(http.MethodGet, "/teams/sync-health-team/sync", nil)
	pageRec := httptest.NewRecorder()
	site.Handler.ServeHTTP(pageRec, pageReq)
	if pageRec.Code != http.StatusOK {
...
func buildTeamSite(t *testing.T) (*apphost.Site, string) {
	...
	site, err := Plugin{}.Build(context.Background(), apphost.Config{
		...
		Plugin:           "aip2p-team",
		Plugins:          []string{"aip2p-content", "aip2p-live", "aip2p-team", "aip2p-archive", "aip2p-governance", "aip2p-ops"},
	}, themeaip2p.Theme{})
	if err != nil {
