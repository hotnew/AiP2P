...
import (
	...
	"aip2p/internal/plugins/aip2pteam/rooms/artifactroom"
	"aip2p/internal/plugins/aip2pteam/rooms/decisionroom"
	"aip2p/internal/plugins/aip2pteam/rooms/handoffroom"
	"aip2p/internal/plugins/aip2pteam/rooms/incidentroom"
	"aip2p/internal/plugins/aip2pteam/rooms/planexchange"
	"aip2p/internal/plugins/aip2pteam/rooms/reviewroom"
	roomthemes "aip2p/internal/themes/room-themes"
	roomboard "aip2p/internal/themes/room-themes/board"
	roomfocus "aip2p/internal/themes/room-themes/focus"
	roomminimal "aip2p/internal/themes/room-themes/minimal"
)
...
func (Plugin) Build(_ context.Context, cfg apphost.Config, theme apphost.WebTheme) (*apphost.Site, error) {
	...
	return &apphost.Site{
		...
		Handler:  newsplugin.WrapLocalizedHandler(newHandler(app, store, staticFS, registry, themeRegistry)),
	}, nil
}
