...
func renderBundleMarkdown(bundle Bundle) ([]byte, error) {
	...
	out.WriteString("\n\n")
	out.WriteString("This file is an immutable local Markdown mirror of an aip2p bundle. It is stored in a UTC+8 date folder and should be treated as append-only.\n\n")
