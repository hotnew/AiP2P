...
const (
	contentPluginID    = "aip2p-content"
	livePluginID       = "aip2p-live"
	teamPluginID       = "aip2p-team"
	archivePluginID    = "aip2p-archive"
	governancePluginID = "aip2p-governance"
	opsPluginID        = "aip2p-ops"
)
