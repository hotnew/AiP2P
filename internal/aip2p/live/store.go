...
func OpenLocalStore(storeRoot string) (*LocalStore, error) {
	return OpenLocalStoreWithRedis(storeRoot, aip2p.RedisConfig{})
}

func OpenLocalStoreWithRedis(storeRoot string, redisCfg aip2p.RedisConfig) (*LocalStore, error) {
	...
	redisClient, err := aip2p.NewRedisClient(redisCfg)
	if err != nil {
