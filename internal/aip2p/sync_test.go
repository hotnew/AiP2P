...
func TestParseSyncRefMagnet(t *testing.T) {
	...
	if ref.Magnet != "aip2p-sync://bundle/93a71a010a59022c8670e06e2c92fa279f98d974?dn=test" {
...
func TestParseSyncRefInfoHash(t *testing.T) {
	...
	if ref.Magnet != "aip2p-sync://bundle/93a71a010a59022c8670e06e2c92fa279f98d974" {
		t.Fatalf("ref = %q", ref.Magnet)
	}
}
...
func TestSanitizeQueuedSyncRefUpgradesLegacyMagnetToNewRef(t *testing.T) {
	...
	if got != "aip2p-sync://bundle/93a71a010a59022c8670e06e2c92fa279f98d974?dn=test&peer=12D3KooWPeerHint" {
...
func TestMigrateHistoryManifestQueueRefsMovesToHistoryQueue(t *testing.T) {
	...
	realtime := strings.Join([]string{
		"aip2p-sync://bundle/aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa?dn=20260327T080000Z-aip2p-history-manifest&peer=12D3KooWHist",
		"aip2p-sync://bundle/bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb?dn=test-post&peer=12D3KooWPost",
		"",
	}, "\n")
...
func TestWriteStatusSkipsRedundantWritesWithinThrottleWindow(t *testing.T) {
	...
	runtime.recordResult(SyncItemResult{Ref: "aip2p-sync://bundle/test", InfoHash: "abc123", Status: "imported"})
	if err := runtime.writeStatus(ctx); err != nil {
