...
func TestLoadPlugins(t *testing.T) {
	...
	if manifests[0].BasePlugin != "aip2p-content" {
...
func (stubPlugin) Manifest() apphost.PluginManifest {
	return apphost.PluginManifest{ID: "aip2p-content", Name: "News Content", DefaultTheme: "aip2p-theme"}
}
...
func (stubTheme) Manifest() apphost.ThemeManifest {
	return apphost.ThemeManifest{ID: "aip2p-theme", Name: "aip2p Public Theme"}
}
