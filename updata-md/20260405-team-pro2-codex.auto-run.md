...
- 已知事实：
  ...
  - 当前文档 [docs/team-room-plugin.md](/Users/haoniu/sh18/aip2p2/aip2p/docs/team-room-plugin.md) 明确指出下一层是：
    - 更多内置 Room Plugins
...
- 输入材料：
  ...
  - 现有代码：
    - `internal/plugins/aip2pteam/rooms/planexchange`
    - `internal/plugins/aip2pteam/roomplugin`
...
- [x] 新建插件目录：
  - `internal/plugins/aip2pteam/rooms/<plugin>/`
- [x] 补齐：
  - `plugin.go`
  - `handler.go`
  - `types.go`
...
- 首选验证命令：
  - `go test ./internal/plugins/aip2pteam ./internal/aip2p/team -count=1`
  - `go test ./internal/plugins/aip2pteam/rooms/... -count=1`
  - `go build ./cmd/aip2p`
- 备用验证方式：
