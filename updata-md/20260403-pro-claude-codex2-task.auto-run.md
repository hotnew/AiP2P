...
- 把 [20260403-pro-claude.md](/Users/haoniu/sh18/aip2p2/20260403-pro-claude.md) 重构成一份 **可直接执行的 `aip2p` 性能改良 runbook**。
...
步骤：
- [ ] 打开 [20260403-pro-claude.md](/Users/haoniu/sh18/aip2p2/20260403-pro-claude.md)，列出 19 个优化项及对应文件。
- [ ] 逐项核当前代码是否已覆盖：
  - Redis 热链
...
文件：
- [redis_summary.go](/Users/haoniu/sh18/aip2p2/aip2p/internal/aip2p/redis_summary.go)
...
文件：
- [store.go](/Users/haoniu/sh18/aip2p2/aip2p/internal/aip2p/team/store.go)
- [store_test.go](/Users/haoniu/sh18/aip2p2/aip2p/internal/aip2p/team/store_test.go)
...
文件：
- [announcement_cache.go](/Users/haoniu/sh18/aip2p2/aip2p/internal/aip2p/announcement_cache.go)
...
文件：
- [subscriptions.go](/Users/haoniu/sh18/aip2p2/aip2p/internal/aip2p/subscriptions.go)
...
文件：
- [sync_supervisor.go](/Users/haoniu/sh18/aip2p2/aip2p/internal/plugins/aip2p/sync_supervisor.go)
...
文件：
- [store.go](/Users/haoniu/sh18/aip2p2/aip2p/internal/aip2p/live/store.go)
...
文件：
- [credit_witness.go](/Users/haoniu/sh18/aip2p2/aip2p/internal/aip2p/credit_witness.go)
...
文件：
- [lanpeer.go](/Users/haoniu/sh18/aip2p2/aip2p/internal/aip2p/lanpeer.go)
- [torrent_http_fallback.go](/Users/haoniu/sh18/aip2p2/aip2p/internal/aip2p/torrent_http_fallback.go)
...
文件：
- [notices.go](/Users/haoniu/sh18/aip2p2/aip2p/internal/aip2p/live/notices.go)
...
- 文件：
  - `internal/aip2p/team/store.go`
  - `internal/aip2p/team/store_test.go`
- 验证：
  - `go test ./internal/aip2p/team -race`
...
- 基准脚本：
  - `python3 scripts/bench_aip2p.py --base-url http://127.0.0.1:51818 --concurrency 20 --requests-per-path 80`
- 未额外 warmup 时：
  - `/` `p95 ~ 1065.7ms`
...
- `go test ./internal/aip2p ./internal/aip2p/live ./internal/plugins/aip2p -run 'TestReadRedisSyncSummary|TestLoadCachedSyncAnnouncementsByTopicAndChannel|TestStoreAppendTaskConcurrentPreservesAllTasks|TestTrimRestartWindowAndCircuitWait|TestLocalStoreUsesRedisCacheForRoomAndEvents|TestListRoomsFallsBackToRoomSummaryWithoutEventsScan'`
- `go test ./internal/aip2p/team -run 'TestStoreAppendTaskConcurrentPreservesAllTasks|TestStoreAppendAndLoadMessages|TestStoreSaveMembersNormalizesStatusesForApprovalFlow|TestStoreNormalizesTaskStatusPriorityAndArtifactTaskID'`
- `go test ./internal/aip2p -run 'TestSubscribedAnnouncementTopics|TestMatchesAnnouncement|TestMatchesHistoryAnnouncement|TestMatchPublicKeyFilters'`
- `go test ./internal/plugins/aip2p -run 'TestApplySubscriptionRules|TestPendingApprovalPostsRespectWhitelistFilters|TestSubscriptionRulesNormalizeTopicAliases|TestApprovalAutoApproveSelectorsNormalization'`
- `go test ./internal/aip2p -run 'TestRequestCreditWitness|TestSelectWitnessCandidatesDeterministic|TestCollectWitnessesFromCandidatesStopsAfterLimit'`
- `go test ./internal/aip2p/team -run 'TestStoreAppendAndLoadMessages|TestStoreLoadMessagesLimitReadsLatestMessages|TestStoreLoadChannelMessagesAlias'`
- `go test ./internal/aip2p -run 'TestResolveLANBootstrapPeersFetchesCandidatesInParallel|TestFetchBundleFallbackPayloadReturnsFastSuccess|TestResolveExplicitBootstrapPeers|TestSortLANPeerCandidates|TestCandidateBundleURLs|TestWithSourcePeerHint'`
- `go test ./internal/plugins/aip2pops ./internal/plugins/aip2pcontent ./internal/plugins/aip2p -run 'TestPluginBuildServesBootstrapReadinessColdStart|TestPluginBuildServesBootstrapReadinessReadyByDefault'`
- `go build ./cmd/aip2p`
...
- 文件：
  - `internal/plugins/aip2pcontent/plugin.go`
  - `internal/plugins/aip2p/http_cache.go`
  - `internal/plugins/aip2p/index_cache.go`
- 验证：
  - 先复跑：
    - `python3 scripts/bench_aip2p.py --base-url http://127.0.0.1:51818 --concurrency 20 --requests-per-path 80`
    - `python3 scripts/bench_aip2p.py --base-url http://127.0.0.1:51818 --concurrency 20 --requests-per-path 80 --warmup-per-path 3`
