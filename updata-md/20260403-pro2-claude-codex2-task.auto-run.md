...
- 把 [20260403-pro2-claude.md](/Users/haoniu/sh18/aip2p2/aip2p/20260403-pro2-claude.md) 收敛成一份可直接执行的 `aip2p` 改良 runbook。
- 目标不是机械完成原文所有条目，而是：
  - 先核对原文判断和当前代码现实是否一致
  - 再按关键路径执行仍然值得做的项
  - 每一批都带验证闭环
...
- 源文档：
  - [20260403-pro2-claude.md](/Users/haoniu/sh18/aip2p2/aip2p/20260403-pro2-claude.md)
- 后续执行模式目标：
  - `$auto-run-plan2`
- 当前规划必须假设：
  - 源文档有一部分判断可能已经过时
...
- [internal/plugins/aip2plive/handler.go](/Users/haoniu/sh18/aip2p2/aip2p/internal/plugins/aip2plive/handler.go)
...
文件：
- [internal/plugins/aip2p/subscriptions.go](/Users/haoniu/sh18/aip2p2/aip2p/internal/plugins/aip2p/subscriptions.go)
- [internal/aip2p/subscriptions.go](/Users/haoniu/sh18/aip2p2/aip2p/internal/aip2p/subscriptions.go)
...
文件：
- [internal/aip2p/credit_witness.go](/Users/haoniu/sh18/aip2p2/aip2p/internal/aip2p/credit_witness.go)
...
文件：
- [internal/aip2p/lanpeer.go](/Users/haoniu/sh18/aip2p2/aip2p/internal/aip2p/lanpeer.go)
...
文件：
- [internal/aip2p/pubsub.go](/Users/haoniu/sh18/aip2p2/aip2p/internal/aip2p/pubsub.go)
...
- 运行最相关测试，不做无差别全仓扫：
  - `go test ./internal/plugins/aip2pteam`
  - `go test ./internal/plugins/aip2plive`
  - `go test ./internal/plugins/aip2p`
  - `go test ./internal/aip2p`
  - `go test ./internal/aip2p/team`
  - `go test ./internal/aip2p/live`
- 并发/竞态修复项必须补：
  - `go test ... -race`
- 构建至少要过：
  - `go build ./cmd/aip2p`
...
- `B3 Subscription normalize / cache`
  - [internal/plugins/aip2p/server.go](/Users/haoniu/sh18/aip2p2/aip2p/internal/plugins/aip2p/server.go)
...
- `C3 Live archive 列表页深度优化`
  - [internal/aip2p/live/store.go](/Users/haoniu/sh18/aip2p2/aip2p/internal/aip2p/live/store.go)
...
- `E2 Team / Live 启动预热`
  ...
  - [internal/plugins/aip2plive/plugin.go](/Users/haoniu/sh18/aip2p2/aip2p/internal/plugins/aip2plive/plugin.go)
  - 非测试进程启动后持续后台预热：
...
- `E3 Index / NodeStatus stale-while-revalidate`
  - [internal/plugins/aip2p/server.go](/Users/haoniu/sh18/aip2p2/aip2p/internal/plugins/aip2p/server.go)
  - [internal/plugins/aip2p/ops_status.go](/Users/haoniu/sh18/aip2p2/aip2p/internal/plugins/aip2p/ops_status.go)
  - [internal/plugins/aip2p/index_cache_test.go](/Users/haoniu/sh18/aip2p2/aip2p/internal/plugins/aip2p/index_cache_test.go)
  - [internal/plugins/aip2p/ops_status_cache_test.go](/Users/haoniu/sh18/aip2p2/aip2p/internal/plugins/aip2p/ops_status_cache_test.go)
...
- `go test ./internal/aip2p -run 'TestCollectWitnessesFromCandidatesStopsAfterLimit|TestCollectWitnessesFromCandidatesCapsConcurrency|TestSortLANPeerCandidates|TestLANPeerHealthCacheRoundTrip|TestResolveLANBootstrapPeersFetchesCandidatesInParallel'`
- `go test -race ./internal/aip2p -run 'TestCollectWitnessesFromCandidatesStopsAfterLimit|TestCollectWitnessesFromCandidatesCapsConcurrency|TestSortLANPeerCandidates|TestLANPeerHealthCacheRoundTrip|TestResolveLANBootstrapPeersFetchesCandidatesInParallel'`
- `go test ./internal/plugins/aip2plive -run 'TestPluginBuildUpdatesLivePublicModerationRules|TestPluginBuildRejectsSpoofedForwardedForOnLivePublicModeration|TestPluginBuildCreatesAndServesLiveHistoryArchive'`
- `go test ./internal/plugins/aip2pteam -run 'TestPluginBuildServesTeamDetailAndAPI|TestPluginBuildTeamTaskAndArtifactWorkflows|TestPluginBuildCreatesTaskFromHTMLForm'`
- `go test ./internal/plugins/aip2p -run 'TestAppSubscriptionRulesCachesUntilFileChanges|TestLoadSubscriptionRulesNormalizesDiscoverySelectors|TestApplySubscriptionRulesFiltersByTopicAndCarriesReplies'`
- `go test ./internal/aip2p -run 'TestPubSubRuntimeReserveSubscriptionRespectsLimit|TestPubSubRuntimeConnectDiscoveredPeersCapsConcurrency|TestPubSubRuntimeConnectDiscoveredPeersRecordsErrors|TestPubSubRuntimeConnectDiscoveredPeersSkipsExistingAndSelf|TestSubscribedAnnouncementTopics|TestMatchesAnnouncement'`
- `go test -race ./internal/aip2p -run 'TestPubSubRuntimeReserveSubscriptionRespectsLimit|TestPubSubRuntimeConnectDiscoveredPeersCapsConcurrency|TestPubSubRuntimeConnectDiscoveredPeersRecordsErrors|TestPubSubRuntimeConnectDiscoveredPeersSkipsExistingAndSelf|TestSubscribedAnnouncementTopics|TestMatchesAnnouncement'`
- `go test ./internal/aip2p/live -run 'TestListHistoryArchivesUsesRedisCache|TestCreateManualAndDailyHistoryArchives|TestHistoryArchivesKeepAllVisibleEventsBeyondDisplayWindow'`
- `go test ./internal/plugins/aip2plive -run 'TestPluginBuildCreatesAndServesLiveHistoryArchive'`
- `go test ./internal/aip2p/team -run 'TestStoreAppendAndLoadMessages|TestStoreLoadMessagesLimitReadsLatestMessages|TestStoreAppendAndLoadTasks|TestStoreLoadTasksLimitReadsLatestTasks|TestStoreSaveMembersAndLoadArtifacts|TestStoreLoadArtifactsAndHistoryLimitReadLatestEntries|TestStoreAppendTaskConcurrentPreservesAllTasks|TestStoreSaveAndDeleteTask'`
- `go test ./internal/plugins/aip2pteam -run 'TestPluginBuildServesTeamDetailAndAPI|TestPluginBuildTeamTaskAndArtifactWorkflows|TestPluginBuildCreatesTaskFromHTMLForm|TestPluginBuildServesTeamArchiveRoutes|TestPluginBuildCreatesTeamArchiveFromWorkspaceRoutes'`
- `go test ./internal/plugins/aip2plive -run 'TestPluginBuildCreatesAndServesLiveHistoryArchive|TestPluginBuildLimitsVisibleLiveEventsButCanShowAll|TestPluginBuildServesLiveIndex'`
- `go test ./internal/plugins/aip2p -run 'TestAppIndexCachesUntilStoreSignatureChanges|TestCurrentIndexSignatureUsesQuickProbeCacheBetweenDeepChecks|TestAppIndexReturnsStaleWhileRefreshingAfterProbeExpiry|TestNodeStatusReturnsStaleWhileRefreshing'`
- `go build ./cmd/aip2p`
