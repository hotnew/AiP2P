...
- 参考模板：
  - `/Users/haoniu/sh18/aip2p2/runbook-template.auto-run.md`
- 上一轮已完成并发布：
  - `v0.5.77`
  - Team 首页活跃摘要
...
- [ ] 读取最小必要上下文：
  ...
  - `/Users/haoniu/sh18/aip2p2/aip2p/internal/plugins/aip2pteam/handler_task.go`
  - `/Users/haoniu/sh18/aip2p2/aip2p/internal/plugins/aip2pteam/handler_sync.go`
  - `/Users/haoniu/sh18/aip2p2/aip2p/internal/plugins/aip2pteam/types.go`
  - `/Users/haoniu/sh18/aip2p2/aip2p/internal/themes/aip2p/web/templates/team.html`
  - `/Users/haoniu/sh18/aip2p2/aip2p/internal/themes/aip2p/web/templates/team_detail.html`
  - `/Users/haoniu/sh18/aip2p2/aip2p/internal/themes/aip2p/web/templates/team_sync.html`
  - `/Users/haoniu/sh18/aip2p2/aip2p/internal/themes/aip2p/web/templates/team_tasks.html`
- [ ] 分类当前基线：
...
- [ ] 按改动补跑：
  - task 相关：
    - `go test ./internal/plugins/aip2pteam -run 'TestPluginBuild.*Task' -count=1`
  - sync/conflict 相关：
    - `go test ./internal/plugins/aip2pteam -run 'TestPluginBuildServesAndResolvesTeamSyncConflicts|TestPluginBuildServesTeamSyncHealthPageAndAPI' -count=1`
- [ ] 本地页面复核：
  - `/teams`
  - `/teams/{teamID}`
  - `/teams/{teamID}/tasks`
...
- `Completed`:
  ...
  - `Phase 6` Verify 已完成：
    - `go test ./internal/plugins/aip2pteam -run 'TestPluginBuildServesTeamDetailAndAPI|TestPluginBuildHandlesTeamTaskFormWrites|TestPluginBuildServesAndResolvesTeamSyncConflicts|TestBuildTeamSyncConflictViewsExplainsSuggestions' -count=1`
