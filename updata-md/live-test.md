...
- 程序：
  - `/Users/haoniu/go/bin/aip2p`
  - `/Users/haoniu/.aip2p/bin/aip2p-syncd`
- 存储：
  - `/Users/haoniu/.aip2p/aip2p/.aip2p`
- 配置：
  - `/Users/haoniu/.aip2p/aip2p_net.inf`
  - `/Users/haoniu/.aip2p/network_id.inf`
...
- 备注：
  ...
  - 原始事件文件：
    - `/Users/haoniu/.aip2p/aip2p/.aip2p/live/live-strict-20260330-0115/events.jsonl`
  - 房间 API：
    - `message = 12`
    - `task_update = 3`
