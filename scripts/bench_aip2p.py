#!/usr/bin/env python3
"""Minimal aip2p latency and error-rate benchmark.
...
Usage examples:
  ...
  python3 scripts/bench_aip2p.py --base-url http://127.0.0.1:51818 --concurrency 20 --requests-per-path 100
